...
final class AddGoalViewController11: UIViewController {
    //MARK: - Components
    ...
    //MARK: - Top Components
    let slideIndicator = NeumorphicView(backgroundColor: .crayon)
    ...
    let viewModel = AddGoalViewModel11()
...
extension AddGoalViewController11: UITextViewDelegate {
...
extension Reactive where Base: AddGoalViewController11 {
